...
import { Clapperboard, Globe, Images, Sparkles } from 'lucide-react';
import Workbench from './components/Workbench';
import VideoAnalysisPage from './components/video_analysis_page';
import MaterialLibraryPage from './components/material_library_page';
    ...
    <div className="flex h-screen bg-background overflow-hidden selection:bg-primary/30">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          {activeTab === 'material-library' && <MaterialLibraryPage />}
        </div>
