...
const SECRET_KEY = import.meta.env.VITE_ENCRYPTION_KEY || "KOLForge-Static-Salt-Change-Me";
...
const SESSION_KEY = 'kolforge_session';
  ...
  const Sidebar = () => (
    <div className="w-20 lg:w-64 bg-surface border-r border-white/5 flex flex-col h-full shrink-0 transition-all duration-300">
      ...
      <div className="p-4 border-t border-white/5 space-y-2">
        <a
          href="#"
          onClick={(e) => { e.preventDefault(); localStorage.removeItem('kolforge_skip_landing'); window.location.hash = ''; window.location.reload(); }}
